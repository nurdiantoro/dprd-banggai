...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="<?= base_url('admin/editEdocument/') . $doc->id ?>" method="POST" enctype="multipart/form-data">
            <table class="w-100">
                <tr>
                    <td>Judul e-Document</td>
                    <td>:</td>
                    <td>
                        <input type="text" class="form-control" name="judul" value="<?= $doc->judul ?>">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <input class="form-control" type="text" name="file" disabled value="<?= $doc->file ?>">
